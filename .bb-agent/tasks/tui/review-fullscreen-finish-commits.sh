...
STATE_DIR="/tmp/bb-fullscreen-finish/review-state"
LOG="/tmp/bb-fullscreen-finish/review-events.log"
INTERVAL="${1:-30}"

mkdir -p "$STATE_DIR"

BRANCH_DIRS=(
  "/tmp/bb-fullscreen-finish/r39-integration"
  "/tmp/bb-fullscreen-finish/r40-streaming"
  "/tmp/bb-fullscreen-finish/r41-runtime"
  "/tmp/bb-fullscreen-finish/r42-verify"
)
