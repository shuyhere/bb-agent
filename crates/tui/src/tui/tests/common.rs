...
pub(super) fn sample_state() -> (TuiState, BlockId, BlockId, BlockId) {
...
pub(super) fn scrolling_state() -> (TuiState, Vec<BlockId>) {
    let mut transcript = Transcript::new();
...
pub(super) fn screen_row_for_header(state: &TuiState, block_id: BlockId) -> u16 {
...
pub(super) fn screen_row_for_first_content(state: &TuiState, block_id: BlockId) -> u16 {
