//! Key, mouse, paste, resize, and tick event handlers for [`FullscreenState`].
...
use super::{
    ...
    runtime::{FullscreenMode, FullscreenState, FullscreenSubmission},
...
impl FullscreenState {
        ...
        self.transcript
            ...
            .map(|block| {
                if block.title.trim().is_empty() {
                    ...
                    format!("\u{201c}{}\u{201d}", block.title)
                }
            })
    ...
    // ------------------------------------------------------------------
    // Helpers used exclusively by the handlers above
    // ------------------------------------------------------------------
