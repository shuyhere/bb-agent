...
pub(super) fn fullscreen_auth_display_name(provider: &str) -> String {
    crate::login::provider_display_name(provider)
}

pub(super) fn fullscreen_auth_status_detail(provider: &str) -> String {
...
pub(super) fn build_preparing_oauth_dialog(label: &str, status: &str) -> FullscreenAuthDialog {
...
pub(super) fn build_copilot_enterprise_dialog() -> FullscreenAuthDialog {
    FullscreenAuthDialog {
...
pub(super) fn build_api_key_dialog(label: &str, url: &str) -> FullscreenAuthDialog {
    FullscreenAuthDialog {
        title: format!("Sign in to {label}"),
