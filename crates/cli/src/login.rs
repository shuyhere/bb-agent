...
use store::{
    AuthEntry, load_auth, provider_storage_key, stored_auth_entry_for_method,
    stored_auth_methods_for_store,
};
...
pub(crate) use store::{
    ...
    save_github_copilot_config, set_active_auth_method, stored_auth_methods,
};
